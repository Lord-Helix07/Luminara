...
export default function LuminaraHomepage() {
  ...
  const formValid = useMemo(() => {
    ...
    if (pageRange === "custom") {
      ...
      if (!startPage || !endPage || Number.isNaN(start) || Number.isNaN(end)) return false;
  ...
  const handleDrop = (e) => {
    ...
    if (dropped) setFileWithInferredFormat(dropped);
  };
  ...
  const handleFileInputChange = (e) => {
    ...
    if (f) setFileWithInferredFormat(f);
  };
      ...
      <div style={{
        ...
        <header style={{
          ...
          <h1 style={{
            ...
            color: t.title, letterSpacing: "0.01em",
          }}>Luminara</h1>
          <div ref={settingsRef} style={{ position: "absolute", right: "48px" }}>
            <button
              ...
              style={{
                background: "none", border: "none", cursor: "pointer", color: t.settingsIcon, padding: "4px",
                borderRadius: "8px",
              }}
            >
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: "48px", alignItems: "stretch" }}>
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "22px" }}>
                ...
                {/* Page Range */}
                <div>
                  <label style={{ fontSize: "14px", fontWeight: "500", color: t.text, display: "block", marginBottom: "10px" }}>
                    Page Range
                  </label>
                  {[["all", "All pages"], ["custom", "Custom"]].map(([val, label]) => (
                    <label key={val} onClick={() => setPageRange(val)} style={{
                      display: "flex", alignItems: "center", gap: "10px",
                      cursor: "pointer", fontSize: "14px", marginBottom: "10px", color: t.text,
                    }}>
                      <div style={{
                        width: "18px", height: "18px", borderRadius: "50%",
                        border: `2px solid ${pageRange === val ? t.radioOn : t.radioBorder}`,
                        background: pageRange === val ? t.radioOn : t.inputBg,
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "4px" }}>
                      <input
                        ...
                        style={{
                          ...
                          border: `1px solid ${t.selectBorder}`, fontSize: "13px", color: t.inputFg,
                          fontFamily: "'DM Sans', sans-serif", textAlign: "center", background: t.inputBg,
                        }}
                      />
                ...
                {/* Accessibility */}
                <div>
                  <p style={{ fontSize: "11px", fontWeight: "600", color: t.sectionMuted, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "14px" }}>
                ...
                {/* TTS Expandable */}
                <div style={{ border: `1px solid ${t.ttsPanelBorder}`, borderRadius: "12px", background: t.ttsPanelBg }}>
                  <button onClick={() => setTtsExpanded(!ttsExpanded)} style={{
                    width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center",
                    padding: "14px 18px", background: "none", border: "none", cursor: "pointer",
                    fontSize: "14px", fontWeight: "500", fontFamily: "'DM Sans', sans-serif", color: t.text,
                  }}>
                    Text-to-Speech Options
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={t.textSoft} strokeWidth="2"
                      style={{ transform: ttsExpanded ? "rotate(180deg)" : "rotate(0deg)", transition: "0.2s" }}>
                      <polyline points="6 9 12 15 18 9"/>
                    </svg>
                  </button>
                  {ttsExpanded && (
                    <div style={{ padding: "0 18px 18px", borderTop: `1px solid ${t.ttsPanelBorder}` }}>
                      <div style={{ marginTop: "14px" }}>
                        <label style={{ fontSize: "13px", display: "block", marginBottom: "8px", color: t.text }}>Voice</label>
                        <select value={voice} onChange={(e) => setVoice(e.target.value)} style={{
                          width: "100%", padding: "8px 10px", borderRadius: "8px",
                          border: `1px solid ${t.selectBorder}`, fontSize: "13px",
                          fontFamily: "'DM Sans', sans-serif",
                          background: t.selectBg, color: t.selectFg,
                        }}>
                      ...
                      <div style={{ marginTop: "14px" }}>
                        <label style={{ fontSize: "13px", display: "block", marginBottom: "8px", color: t.text }}>
                          Playback Speed: <span style={{ color: t.brand, fontWeight: "600" }}>{speed.toFixed(1)}x</span>
                        </label>
                        <input type="range" min="0.5" max="2.0" step="0.1" value={speed}
                          onChange={(e) => setSpeed(parseFloat(e.target.value))}
                          style={{ width: "100%", accentColor: t.brand }} />
                        <div style={{ display: "flex", justifyContent: "space-between", fontSize: "11px", color: t.textSoft, marginTop: "4px" }}>
                ...
                <button onClick={handleReset} style={{
                  background: "none", border: "none", color: t.resetLink, fontSize: "13px",
            ...
            {error ? (
              <p style={{
                marginTop: "20px", color: t.error, fontSize: "14px", textAlign: "center",
              }} role="alert">{error}</p>
            ) : null}
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!e.target.disabled) e.target.style.background = t.btnHover;
              }}
              onMouseLeave={(e) => {
                if (!e.target.disabled) e.target.style.background = t.btn;
              }}
              style={{
                width: "100%", marginTop: "16px", padding: "18px",
                background: !formValid || loading ? t.btnDisabled : t.btn, color: "white", border: "none",
                borderRadius: "12px", fontSize: "16px", fontWeight: "500",
                cursor: !formValid || loading ? "not-allowed" : "pointer", fontFamily: "'DM Sans', sans-serif", letterSpacing: "0.02em",
            ...
            {loading ? (
              <div
                ...
                style={{
                  marginTop: "12px", height: "8px", borderRadius: "4px",
                  background: t.loadTrack, overflow: "hidden", width: "100%",
                }}
              >
                <div
                  style={{
